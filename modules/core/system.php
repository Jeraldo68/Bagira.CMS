...
class system {
	...
	*/
	...
	/**
	 * @return array $rgb - массив значений цвета в формате RGB
	 * @param string $hex - цвет в формате HEX может быть как с "#" так и без
	 * @desc Функция преобразуется цвет из HEX в RGB формат
	 */
	...
	*/
	...
	static function translite($str) {
		...
		$str = str_replace($bad_symbols, '_', $str);
