...
$LANG['CONSTR_FORM_FIELD'][12] = 'Шаблон страницы по умолчанию';
$LANG['CONSTR_FORM_FIELD'][13] = 'Укажите шаблон, который должен автоматически выбираться при создании объекта данного класса. Используется в модуле «Структура».';
$LANG['CONSTR_FORM_FIELD'][14] = 'Шаблон содержания по умолчанию';
$LANG['CONSTR_FORM_FIELD'][15] = 'Укажите шаблон, который должен автоматически выбираться при создании объекта данного класса. Используется в модуле «Структура».';
...
$LANG['CONSTR_FORM_FIELD3'][21] = 'ID раздела с которого строить дерево';
